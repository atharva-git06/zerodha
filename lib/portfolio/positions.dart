            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    const Text('Total P&L',style: TextStyle(
                        color: Colors.grey,
                        fontSize: 15
                    ),),
                    SizedBox(height: SizeConfig.blockSizeVertical*0.5,),
                    const Text('+8000.00',style: TextStyle(
                        color: Colors.green,
                        fontSize: 18
                    ),),
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          Icon(Icons.search,color:Colors.blue ,size: 14,),
                      ...
                      Row(
                        children: <Widget>[
                          Icon(Icons.settings,color:Colors.blue ,size: 14,),
                          SizedBox(width: SizeConfig.blockSizeHorizontal*2,),
                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      Icon(Icons.circle_outlined,color: Colors.blue[900],),
                      SizedBox(width: SizeConfig.blockSizeHorizontal*1,),
